#!/usr/bin/env python3
"""Sequential manga colorization with fal FLUX.2 Klein 9B Edit and a style reference."""
...
METHOD_NAME = "fal-flux-2-klein-9b-edit-style-ref-sequential"
    ...
    manifest: dict[str, Any] = {
        ...
        "preprocessing": {
            ...
            "style_reference": (
                ...
                "once per run and reused by URL. Supplied as #3 on every request."
            ),
            "source_pages": (
